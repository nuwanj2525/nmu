(function () {
    ...
    function UserService($http) {
        ...
        function GetAll() {
            return $http.get('/users/getList').then(handleSuccess, handleError('Error getting all users'));
        }

        function GetById(id) {
            return $http.get('/users/getById/' + id).then(handleSuccess, handleError('Error getting user by id'));
        }
